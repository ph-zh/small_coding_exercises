/*
Вы продолжаете работать с массивом валют. В коде отражено, что пользователь может выбрать любую
из валют, а затем сообщить программе свой выбор. Это происходит с помощью индексов элементов. Пользователю
сообщаются индексы и предлагается ввести номер того, который соответствует валюте, которую он хочет заменить.
